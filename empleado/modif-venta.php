...
$consulta="SELECT * FROM venta where codVenta='$CODVENTA'";
...
<body>
  ...
  <header class="p-3 text-bg-dark">
    ...
    <form class="row g-3 m-auto" action="validar-modif-venta.php?CODVENTA=<?php echo $_GET['CODVENTA'] ?>" method="post">
    <input type="hidden" name="CODVENTA" value="<?php echo $datos["codVenta"] ?>">
    ...
    <input type="hidden" name="CODVEHICULO" value="<?php echo $datos["codVehiculo"] ?>">
        ...
        <div class="col-md-6">
            ...
            <select class="form-select" aria-label="Default select example" name="regDescuento" value="<?php echo $datos['Descuento'] ?>">
        ...
        <div class="col-md-6">
          ...
          <input type="date" class="form-control" placeholder="1998/12/05" name="regVenta" value="<?php echo $datos['fechaVenta'] ?>">
        </div>

          <div class="col-md-6">
            <label class="form-label">Precio</label>
            <input type="number" class="form-control" placeholder="1233" name="regPrecio" value="<?php echo $datos['precioVenta'] ?>">
          </div>

        <div class="col-12">
          <button type="submit" class="btn btn-primary" name="Registrar">Registrar</button>
          <a href="ventasform.php" class="btn btn-danger">Volver</a>
        </div>
      </form>
      <br>
</body>
