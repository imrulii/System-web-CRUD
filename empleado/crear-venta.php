...
<body>
  ...
  <header class="p-3 text-bg-dark">
    ...
    <form class="row g-3 m-auto" action="validar-venta.php" method="post">
        <div class="col-md-4">
          <label class="form-label">Codigo de venta</label>
          <input type="number" class="form-control" name="regCodVenta">
        </div>
        ...
        <div class="col-md-4">
            ...
            <select class="form-select" aria-label="Default select example" name="regDescuento">
        ...
        <div class="col-md-8">
          ...
          <input type="date" class="form-control" placeholder="1998/12/05" name="regVenta">
        </div>
