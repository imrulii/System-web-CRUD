...
$consulta="SELECT * FROM alquiler where codAlquiler='$CODALQUILER'";
...
<body>
  ...
  <header class="p-3 text-bg-dark">
    ...
    <form class="row g-3 m-auto" action="validar-modif-alquiler.php?CODALQUILER=<?php echo $_GET['CODALQUILER'] ?>" method="post">
    <input type="hidden" name="CODVENTA" value="<?php echo $datos["codAlquiler"] ?>">
    ...
    <input type="hidden" name="CODVEHICULO" value="<?php echo $datos["codVehiculo"] ?>">
        ...
        <div class="col-md-6">
          <label class="form-label">Fecha alquiler</label>
          <input type="date" class="form-control" placeholder="1998/12/05" name="regAlquiler" value="<?php echo $datos['fechaAlquiler'] ?>">
        </div>

        <div class="col-md-6">
          <label class="form-label">Fecha de devolucion</label>
          <input type="date" class="form-control" placeholder="1998/12/05" name="regDevolucion" value="<?php echo $datos['fechaDevolucion'] ?>">
        </div>

        <div class="col-md-6">
            <label class="form-label">Metodo de pago</label>
            <select class="form-select" aria-label="Default select example" name="regPago" value="<?php echo $datos['metodoPago'] ?>">
          ...
          <div class="col-md-6">
            ...
            <input type="number" class="form-control" placeholder="1233" name="regPrecio" value="<?php echo $datos['precioAlquiler'] ?>">
          </div>
