<?php include ('db.php');
      $datos= [];
      $sql=("SELECT Marca, Modelo, origenPais, Precio, count(*) as registro FROM alquiler
      inner join vehiculos on alquiler.codVehiculo= vehiculos.codVehiculo GROUP BY Modelo");
...
<body>
  ...
  <h4 style="text-align: center;">
    Consulta de Alquileres de Vehiculos
  </h4>
</div>
  </div>
  ...
  <table class="table table-striped table-hover table_id">
    <thead>
      <tr>
        <th scope="col">CANTIDAD ALQUILADAS</th>
  ...
  <a href="alquiler-pdf.php" class="btn btn-danger">Imprimir consulta</a>
  </div>
<br>
<?php 
