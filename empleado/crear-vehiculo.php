...
<body>
  ...
  <header class="p-3 text-bg-dark">
    ...
    <form class="row g-3 m-auto" action="validar-vehiculo.php" method="post">
        <div class="col-md-6">
          <label class="form-label">Marca</label>
          <input type="text" class="form-control" name="regMarca" placeholder="Toyota">
        </div>

        <div class="col-md-6">
          <label class="form-label">Modelo</label>
          <input type="text" class="form-control" placeholder="Onix" name="regModelo">
        </div>

        <div class="col-md-2">
          <label class="form-label">Codigo del vehiculo</label>
          <input type="number" class="form-control" name="regCodVehiculo" placeholder="34561123124" >
        </div>

        <div class="col-md-2">
          <label  class="form-label">Pais del vehiculo</label>
          <input type="text" class="form-control" name="regPais">
        </div>

        <div class="col-md-8">
          <label class="form-label">Fecha de ingreso</label>
          <input type="date" class="form-control" placeholder="1998/12/05" name="regIngreso">
        </div>

        <div class="col-md-2">
          <label class="form-label">Usado</label>
          <select class="form-select" aria-label="Default select example" name="regUsado">
          ...
          <div class="col-md-2">
            ...
            <input type="text" class="form-control" placeholder="1233" name="regKilometraje">
          </div>

          <div class="col-md-2">
            <label class="form-label">Tipo de combustible</label>
            <select class="form-select" aria-label="Default select example" name="regCombustible">
          ...
          <div class="col-md-2">
            ...
            <select class="form-select" aria-label="Default select example" name="regCaja">
          ...
          <div class="col-md-2">
            ...
            <select class="form-select" aria-label="Default select example" name="regTransmision">
          ...
          <div class="col-md-6">
            ...
            <input type="number" class="form-control" name="regCantidad" placeholder="50">
          </div>

          <div class="col-md-6">
            <label class="form-label">Precio de lista</label>
            <input type="number" class="form-control" name="regPrecio" placeholder="5231.23">
          </div>
