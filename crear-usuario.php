...
<body>
  ...
  <header class="p-3 text-bg-dark">
    ...
    <form class="row g-3 m-auto needs-validation" novalidate  action="validar-usuario-copy.php" method="post">
    <input type="hidden" name="usuario" value="<?php echo $_SESSION["usuario"] ?>">
        <div class="col-md-4 position-relative">
          <label for="validationTooltip01" class="form-label">Nombre y Apellido</label>
          <input type="text" id="validationTooltip01" class="form-control" name="regNombre">
        </div>

        <div class="col-md-4">
          <label class="form-label">DNI</label>
          <input type="number" class="form-control" placeholder="123456789" name="regDNI">
        </div>

        <div class="col-md-4">
          <label class="form-label">Edad</label>
          <input type="number" min="0" max="100" class="form-control" name="regEdad" >
        </div>

        <div class="col-md-2">
          <label class="form-label">Sexo</label>
          <select class="form-select" aria-label="Default select example" name="regSexo">
        ...
        <div class="col-md-6">
          ...
          <input type="number" class="form-control" placeholder="3826123456" name="regTelefono">
        </div>

        <div class="col-md-4">
          <label class="form-label">Email</label>
          <input type="email" class="form-control" placeholder="ejemplo@gmail.com" name="regEmail">
        </div>

        <div class="col-md-2">
            <label class="form-label">Nacionalidad</label>
            <input type="text" class="form-control" name="regNacionalidad">
          </div>

          <div class="col-md-2">
            <label class="form-label">Ciudad</label>
            <input type="text" class="form-control" name="regCiudad">
          </div>

          <div class="col-md-2">
            <label class="form-label">Codigo Postal</label>
            <input type="number" min="1000" max="9999" class="form-control" placeholder="1234" name="regCodPostal">
          </div>

          <div class="col-md-2">
            <label class="form-label">Direccion</label>
            <input type="text" class="form-control" placeholder="San martin" name="regDireccion">
          </div>

          <div class="col-md-2">
            <label class="form-label">Altura</label>
            <input type="number" min="0" max="999" class="form-control" placeholder="312" name="regAltura">
          </div>
