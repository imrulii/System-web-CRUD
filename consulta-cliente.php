<?php include ('db.php');
      $datos= [];
      $sql=("SELECT  Nacionalidad, Ciudad, count(*) as registro  FROM clientes GROUP BY  Ciudad");
...
<body>
  ...
  <h4 style="text-align: center;">
    Consultas de Nacionalidad de los Clientes
  </h4>
</div>
  </div>
  ...
  <a href="cliente-pdf.php" class="btn btn-danger">Imprimir consulta</a>
  </div>
<br>
<?php 
