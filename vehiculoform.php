...
<body>
  ...
  <table class="table table-striped table-hover table_id">
    ...
    <tbody>
      ...
      ?>
        ...
        <td><?php echo $datos [$i] ['Usado']?></td>
        <td><?php echo $datos [$i] ['Kilometraje']?>KM</td>
        <td><?php echo $datos [$i] ['Combustible']?></td>
        <td><?php echo $datos [$i] ['Caja']?></td>
        <td><?php echo $datos [$i] ['Transmision']?></td>
        <td><?php echo $datos [$i] ['fechaIngreso']?></td>
        <td><?php echo $datos [$i] ['Cantidad']?></td>
        <td>$<?php echo $datos [$i] ['Precio']?></td>
        <td><a href="modif-vehiculo.php?CODVEHICULO=<?php echo $datos [$i] ['codVehiculo']?>" class="btn btn-warning"><svg  width="22" height="22" fill="currentColor" class="bi bi-pencil-square" viewBox="0 0 16 16">
          <path d="M15.502 1.94a.5.5 0 0 1 0 .706L14.459 3.69l-2-2L13.502.646a.5.5 0 0 1 .707 0l1.293 1.293zm-1.75 2.456-2-2L4.939 9.21a.5.5 0 0 0-.121.196l-.805 2.414a.25.25 0 0 0 .316.316l2.414-.805a.5.5 0 0 0 .196-.12l6.813-6.814z"/>
          <path fill-rule="evenodd" d="M1 13.5A1.5 1.5 0 0 0 2.5 15h11a1.5 1.5 0 0 0 1.5-1.5v-6a.5.5 0 0 0-1 0v6a.5.5 0 0 1-.5.5h-11a.5.5 0 0 1-.5-.5v-11a.5.5 0 0 1 .5-.5H9a.5.5 0 0 0 0-1H2.5A1.5 1.5 0 0 0 1 2.5v11z"/>
        </svg>
        </a></td>
        <td><a href="borrar-vehiculo.php?CODVEHICULO=<?php echo $datos [$i] ['codVehiculo']?>" class="btn btn-danger"><svg width="22" height="22" fill="currentColor" class="bi bi-trash3-fill"  viewBox="0 0 16 16">
  ...
  <a href="crear-vehiculo.php" class="btn btn-success">Nuevo registro</a>
  </div>
<br>
<?php
