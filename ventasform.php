  ...
  <table class="table table-striped table-hover table_id">
    ...
    <tbody>
      ...
      for($i=0; $i < count($datos); $i++){
        ...
        <td><a href="borrar-venta.php?CODVENTA=<?php echo $datos [$i] ['codVenta']?>" class="btn btn-danger"><svg width="22" height="22" fill="currentColor" class="bi bi-trash3-fill" viewBox="0 0 16 16">
